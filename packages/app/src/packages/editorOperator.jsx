...
export default defineComponent({
  ...
  setup(props) {
    ...
    return () => {
            ...
            Object.entries(component.props).map(([propName, propConfig]) => {
              return (
                <el-form-item label={propConfig.label}>
                  {{
                    input: () => (
                      <el-input v-model={state.editData.props[propName]} />
                    ),
                    color: () => (
                      <el-color-picker
                    ...
                    select: () => (
                      <el-select v-model={state.editData.props[propName]}>
      ...
      if (props?.block?.key === "link") {
        content.push(
          <el-form-item label="跳转链接">
            <el-input v-model={state.editData.props.href} />
          </el-form-item>
        );
      }

      if (props?.block?.key === "img") {
        content.push(
          <el-form-item label="图片链接">
            <el-input v-model={state.editData.props.src} />
          </el-form-item>
        );
      }

      if (props?.block?.key === "carousel") {
        content.push(
          <el-form-item label="图片链接">
            <el-input v-model={state.editData.props.srcs} />
          </el-form-item>
        );
      }
